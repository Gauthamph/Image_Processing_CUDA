...
int main()
{
	...
	const char* outputFileName = "Laplacian.bmp";
	...
	int lp_pos[]={0,1,0,1,-4,1,0,1,0};
	int lp_neg[]={0,-1,0,-1,4,-1,0,-1,0};
	...
	int h_mat[9];
	printf("1. LP_Positive\n2. LP_Negative \n Enter your  choice\n");
	scanf("%d",&ch);

	switch(ch){
		case 1: 
			memcpy((void*)&h_mat,(void*)&lp_pos, (9 * sizeof(int)));
			break;
		case 2:
			memcpy((void*)&h_mat,(void*)&lp_neg, (9 * sizeof(int)));
			break;
