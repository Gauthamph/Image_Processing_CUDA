...
int main()
{
	...
	int ksh_north[] ={5,5,5,-3,0,-3,-3,-3,-3};
	int ksh_south[] ={-3,-3,-3,-3,0,-3,5,5,5};
	int ksh_east[]  ={-3,-3,5,-3,0,5,-3,-3,5};
	int ksh_west[]  ={5,-3,-3,5,0,-3,5,-3,-3};
	...
	switch(ch){
		case 1: 
			memcpy((void*)&h_mat,(void*)&ksh_north, (9 * sizeof(int)));
			break;
		case 2:
			memcpy((void*)&h_mat,(void*)&ksh_south, (9 * sizeof(int)));
			break;

		case 3:
			memcpy((void*)&h_mat,(void*)&ksh_east, (9 * sizeof(int)));
			break;

		case 4:
			memcpy((void*)&h_mat,(void*)&ksh_west, (9 * sizeof(int)));
			break;
		default:
