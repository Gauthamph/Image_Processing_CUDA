...
int main()
{
	...
	int rb_north[] ={-1,0,1,-2,0,2,-1,0,1};
	int rb_south[] ={1,0,-1,2,0,-2,1,0,-1};
	int rb_east[]  ={-1,-2,-1,0,0,0,1,2,1};
	int rb_west[]  = {1,2,1,0,0,0,-1,-2,-1};
	...
	int h_mat[MASK_DIM * MASK_DIM];
	printf("1. North\n2. South\n3. East\n4. West\n Enter your  choice\n");
	scanf("%d",&ch);

	switch(ch){
		case 1: 
			memcpy((void*)&h_mat,(void*)&rb_north, (9 * sizeof(int)));
			break;
		case 2:
			memcpy((void*)&h_mat,(void*)&rb_south, (9 * sizeof(int)));
			break;

		case 3:
			memcpy((void*)&h_mat,(void*)&rb_east, (9 * sizeof(int)));
			break;

		case 4:
			memcpy((void*)&h_mat,(void*)&rb_west, (9 * sizeof(int)));
			break;
		default:
